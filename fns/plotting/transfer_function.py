...
The scalar companion of :mod:`fns.plotting.complex_matrix`: a single complex curve
...
:class:`fns.elements.dynamic_source.TransferFunction`), evaluated on the given grid.
"""
...
def plot_transfer_function(
    ...
    *,
    ...
    funcs : array, callable, or list thereof
        ...
        :class:`fns.elements.dynamic_source.TransferFunction`).  Pass a list to overlay
        several curves.
    freqs : array_like
