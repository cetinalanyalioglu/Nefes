...
Two views over a :class:`fns.elements.continuation.RationalFit` (or any tabulated/fit
pair):
...
same ``(frequency, growth = -Im(omega))`` axes as :func:`fns.plotting.plot_spectrum`.
"""
...
def plot_fit(
    ...
    *,
    ...
    fit : RationalFit or callable
        The continuation to draw.  A :class:`~fns.elements.continuation.RationalFit`
