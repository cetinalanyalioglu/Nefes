...
class TrajectoryBranch:
    ...
    matching :class:`nefes.perturbation.EigenmodeResult`.
...
def eigenvalue_trajectory(
    ...
    *,
    ...
    build : callable
        ...
        **unsolved** network (a :class:`nefes.shell.Network`; it is solved here, warm-started
...
class TrajectoryResult:
    ...
    :class:`nefes.perturbation.EigenmodeResult` (for the starting spectrum and its completeness
    ...
    def plot_vs_param(self, *, title=None, **layout):
        ...
        fig.update_layout(template=NEFES_TEMPLATE_NAME, title=title or f"Eigenvalues vs {self.param_name}")
        fig.update_layout(**layout)
        return fig
